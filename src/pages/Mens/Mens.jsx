...
export const Mens = ({ handleAddproduct }) => {
  const [data, setData] = useState([]);
  const fetching = async () => {
    try {
      let data = await fetch(`http://localhost:8080/products/?type=men`);
  ...
  function handleSort(nameBy, order) {
    if (nameBy === "title" && order === 1)
      setData((prev) => [...prev.sort((a, b) => (a.title > b.title ? 1 : -1))]);
  ...
  return (
    <div className="container">
      <div className="men-first-head">
        ...
        <div className="men-head-bottom">
          <ul>
            <li>All Men's</li>/<li>Shoes</li>/<li>Clothing</li>/
            <li>Accessories</li>
          </ul>
          <div>
